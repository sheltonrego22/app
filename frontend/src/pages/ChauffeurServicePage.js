...
export default function ChauffeurServicePage() {
  ...
  useEffect(() => { document.title = "Chauffeur Service Dubai — Eurogulf Mobility Group"; }, []);
    ...
    <div data-testid="chauffeur-service-page">
      ...
      <section data-testid="chauffeur-service-hero" className="relative min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 pt-28 pb-16 text-center">
          ...
          <span className="font-mono text-xs tracking-[0.3em] text-[#EE5A01] uppercase mb-4 block animate-fade-in">Royal Limousine by Eurogulf Mobility Group</span>
