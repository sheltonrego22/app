      ...
      <section className="bg-[#EE5A01] py-16">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="font-body text-black/70 mb-8 max-w-lg mx-auto">
            Whether you need routine maintenance or comprehensive repairs — Eurogulf Autocare delivers A-grade workshop quality.
          </p>
