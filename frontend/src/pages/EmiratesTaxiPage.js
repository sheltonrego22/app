...
const LOGO_URL = "https://egmg.ae/wp-content/uploads/2025/06/Adobe-Express-file.webp";
    ...
    <div data-testid="emirates-taxi-page">
      ...
      <section data-testid="emirates-taxi-hero" className="relative min-h-[70vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 pt-28 pb-16">
          <img src={LOGO_URL} alt="Emirates Taxi" className="h-12 w-auto mb-6 brightness-0 invert opacity-80" loading="lazy" />
